...
public class CreateMatchRequest : IRequest<CreateMatchRequestResponse>
{
    ...
    [Required] [MaxLength(100)] public string League { get; set; } = string.Empty;

    [Required] [MaxLength(20)] public string Season { get; set; } = string.Empty;

    [Required] public int? Round { get; set; }

    [Required] [MaxLength(200)] public string StadiumName { get; set; } = string.Empty;
